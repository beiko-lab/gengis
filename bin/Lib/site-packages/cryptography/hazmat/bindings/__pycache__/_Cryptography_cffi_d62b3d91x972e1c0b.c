...
static int _cffi_e_____D_enum____D_10(PyObject *lib)
{
...
static int _cffi_e_____D_enum____D_11(PyObject *lib)
{
  ...
  return _cffi_e_____D_enum____D_10(lib);
}

static int _cffi_e_____D_enum____D_12(PyObject *lib)
{
...
static int _cffi_e_____D_enum____D_13(PyObject *lib)
{
  ...
  return _cffi_e_____D_enum____D_12(lib);
}

static int _cffi_e_____D_enum____D_14(PyObject *lib)
{
  ...
  return _cffi_e_____D_enum____D_13(lib);
}
...
static int _cffi_e_____D_enum____D_2(PyObject *lib)
{
  ...
  return _cffi_e_____D_enum____D_14(lib);
}
...
static PyMethodDef _cffi_methods[] = {
  {"_cffi_layout__CCHmacContext", _cffi_layout__CCHmacContext, METH_NOARGS, NULL},
  {"_cffi_layout__CFDictionaryKeyCallBacks", _cffi_layout__CFDictionaryKeyCallBacks, METH_NOARGS, NULL},
  {"_cffi_layout__CFDictionaryValueCallBacks", _cffi_layout__CFDictionaryValueCallBacks, METH_NOARGS, NULL},
  {"_cffi_layout__CFRange", _cffi_layout__CFRange, METH_NOARGS, NULL},
  {"_cffi_layout__SecItemImportExportKeyParameters", _cffi_layout__SecItemImportExportKeyParameters, METH_NOARGS, NULL},
  {"CCCalibratePBKDF", _cffi_f_CCCalibratePBKDF, METH_VARARGS, NULL},
  {"CCCryptorCreate", _cffi_f_CCCryptorCreate, METH_VARARGS, NULL},
  {"CCCryptorCreateWithMode", _cffi_f_CCCryptorCreateWithMode, METH_VARARGS, NULL},
  {"CCCryptorFinal", _cffi_f_CCCryptorFinal, METH_VARARGS, NULL},
  {"CCCryptorGCMAddAAD", _cffi_f_CCCryptorGCMAddAAD, METH_VARARGS, NULL},
  {"CCCryptorGCMAddIV", _cffi_f_CCCryptorGCMAddIV, METH_VARARGS, NULL},
  {"CCCryptorGCMDecrypt", _cffi_f_CCCryptorGCMDecrypt, METH_VARARGS, NULL},
  {"CCCryptorGCMEncrypt", _cffi_f_CCCryptorGCMEncrypt, METH_VARARGS, NULL},
  {"CCCryptorGCMFinal", _cffi_f_CCCryptorGCMFinal, METH_VARARGS, NULL},
  {"CCCryptorGCMReset", _cffi_f_CCCryptorGCMReset, METH_O, NULL},
  {"CCCryptorRelease", _cffi_f_CCCryptorRelease, METH_O, NULL},
  {"CCCryptorUpdate", _cffi_f_CCCryptorUpdate, METH_VARARGS, NULL},
  {"CCHmacFinal", _cffi_f_CCHmacFinal, METH_VARARGS, NULL},
  {"CCHmacInit", _cffi_f_CCHmacInit, METH_VARARGS, NULL},
  {"CCHmacUpdate", _cffi_f_CCHmacUpdate, METH_VARARGS, NULL},
  {"CCKeyDerivationPBKDF", _cffi_f_CCKeyDerivationPBKDF, METH_VARARGS, NULL},
  {"CC_MD5_Final", _cffi_f_CC_MD5_Final, METH_VARARGS, NULL},
  {"CC_MD5_Init", _cffi_f_CC_MD5_Init, METH_O, NULL},
  {"CC_MD5_Update", _cffi_f_CC_MD5_Update, METH_VARARGS, NULL},
  {"CC_SHA1_Final", _cffi_f_CC_SHA1_Final, METH_VARARGS, NULL},
  {"CC_SHA1_Init", _cffi_f_CC_SHA1_Init, METH_O, NULL},
  {"CC_SHA1_Update", _cffi_f_CC_SHA1_Update, METH_VARARGS, NULL},
  {"CC_SHA224_Final", _cffi_f_CC_SHA224_Final, METH_VARARGS, NULL},
  {"CC_SHA224_Init", _cffi_f_CC_SHA224_Init, METH_O, NULL},
  {"CC_SHA224_Update", _cffi_f_CC_SHA224_Update, METH_VARARGS, NULL},
  {"CC_SHA256_Final", _cffi_f_CC_SHA256_Final, METH_VARARGS, NULL},
  {"CC_SHA256_Init", _cffi_f_CC_SHA256_Init, METH_O, NULL},
  {"CC_SHA256_Update", _cffi_f_CC_SHA256_Update, METH_VARARGS, NULL},
  {"CC_SHA384_Final", _cffi_f_CC_SHA384_Final, METH_VARARGS, NULL},
  {"CC_SHA384_Init", _cffi_f_CC_SHA384_Init, METH_O, NULL},
  {"CC_SHA384_Update", _cffi_f_CC_SHA384_Update, METH_VARARGS, NULL},
  {"CC_SHA512_Final", _cffi_f_CC_SHA512_Final, METH_VARARGS, NULL},
  {"CC_SHA512_Init", _cffi_f_CC_SHA512_Init, METH_O, NULL},
  {"CC_SHA512_Update", _cffi_f_CC_SHA512_Update, METH_VARARGS, NULL},
  {"CFArrayGetCount", _cffi_f_CFArrayGetCount, METH_O, NULL},
  {"CFArrayGetValueAtIndex", _cffi_f_CFArrayGetValueAtIndex, METH_VARARGS, NULL},
  {"CFBooleanGetValue", _cffi_f_CFBooleanGetValue, METH_O, NULL},
  {"CFDataCreate", _cffi_f_CFDataCreate, METH_VARARGS, NULL},
  {"CFDataGetBytes", _cffi_f_CFDataGetBytes, METH_VARARGS, NULL},
  {"CFDataGetLength", _cffi_f_CFDataGetLength, METH_O, NULL},
  {"CFDictionaryCreate", _cffi_f_CFDictionaryCreate, METH_VARARGS, NULL},
  {"CFDictionaryCreateMutable", _cffi_f_CFDictionaryCreateMutable, METH_VARARGS, NULL},
  {"CFDictionarySetValue", _cffi_f_CFDictionarySetValue, METH_VARARGS, NULL},
  {"CFNumberCreate", _cffi_f_CFNumberCreate, METH_VARARGS, NULL},
  {"CFRangeMake", _cffi_f_CFRangeMake, METH_VARARGS, NULL},
  {"CFRelease", _cffi_f_CFRelease, METH_O, NULL},
  {"CFRetain", _cffi_f_CFRetain, METH_O, NULL},
  {"CFShow", _cffi_f_CFShow, METH_O, NULL},
  {"CFStringCreateWithCString", _cffi_f_CFStringCreateWithCString, METH_VARARGS, NULL},
  {"SecDecryptTransformCreate", _cffi_f_SecDecryptTransformCreate, METH_VARARGS, NULL},
  {"SecEncryptTransformCreate", _cffi_f_SecEncryptTransformCreate, METH_VARARGS, NULL},
  {"SecItemImport", _cffi_f_SecItemImport, METH_VARARGS, NULL},
  {"SecKeyGeneratePair", _cffi_f_SecKeyGeneratePair, METH_VARARGS, NULL},
  {"SecKeyGetBlockSize", _cffi_f_SecKeyGetBlockSize, METH_O, NULL},
  {"SecKeychainCreate", _cffi_f_SecKeychainCreate, METH_VARARGS, NULL},
  {"SecKeychainDelete", _cffi_f_SecKeychainDelete, METH_O, NULL},
  {"SecPKCS12Import", _cffi_f_SecPKCS12Import, METH_VARARGS, NULL},
  {"SecSignTransformCreate", _cffi_f_SecSignTransformCreate, METH_VARARGS, NULL},
  {"SecTransformExecute", _cffi_f_SecTransformExecute, METH_VARARGS, NULL},
  {"SecTransformSetAttribute", _cffi_f_SecTransformSetAttribute, METH_VARARGS, NULL},
  {"SecVerifyTransformCreate", _cffi_f_SecVerifyTransformCreate, METH_VARARGS, NULL},
  {"_cffi_layout_struct_CC_MD5state_st", _cffi_layout_struct_CC_MD5state_st, METH_NOARGS, NULL},
  {"_cffi_layout_struct_CC_SHA1state_st", _cffi_layout_struct_CC_SHA1state_st, METH_NOARGS, NULL},
  {"_cffi_layout_struct_CC_SHA256state_st", _cffi_layout_struct_CC_SHA256state_st, METH_NOARGS, NULL},
  {"_cffi_layout_struct_CC_SHA512state_st", _cffi_layout_struct_CC_SHA512state_st, METH_NOARGS, NULL},
...
static struct PyModuleDef _cffi_module_def = {
  ...
  "_Cryptography_cffi_d62b3d91x972e1c0b",
  NULL,
  -1,
  _cffi_methods,
  NULL, NULL, NULL, NULL
...
PyMODINIT_FUNC
PyInit__Cryptography_cffi_d62b3d91x972e1c0b(void)
{
  PyObject *lib;
