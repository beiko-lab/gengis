...
class Dataset(MajorObject):
    ...
    def WriteRaster(self, *args, **kwargs):
        ...
        WriteRaster(Dataset self, int xoff, int yoff, int xsize, int ysize, GIntBig buf_len, int * buf_xsize=None, 
            int * buf_ysize=None, GDALDataType * buf_type=None, int band_list=0, int * buf_pixel_space=None, 
    ...
    def ReadRaster1(self, *args, **kwargs):
        ...
        ReadRaster1(Dataset self, int xoff, int yoff, int xsize, int ysize, int * buf_xsize=None, int * buf_ysize=None, 
            GDALDataType * buf_type=None, int band_list=0, int * buf_pixel_space=None, 
            int * buf_line_space=None, int * buf_band_space=None) -> CPLErr
        """
...
class Band(MajorObject):
    ...
    def WriteRaster(self, *args, **kwargs):
        ...
        WriteRaster(Band self, int xoff, int yoff, int xsize, int ysize, GIntBig buf_len, int * buf_xsize=None, 
            int * buf_ysize=None, int * buf_type=None, int * buf_pixel_space=None, int * buf_line_space=None) -> CPLErr
        """
    ...
    def GetDefaultHistogram(self, *args, **kwargs):
        """
        GetDefaultHistogram(Band self, double * min_ret=None, double * max_ret=None, int * buckets_ret=None, int ** ppanHistogram=None, 
    ...
    def ReadRaster1(self, *args, **kwargs):
        """
        ReadRaster1(Band self, int xoff, int yoff, int xsize, int ysize, int * buf_xsize=None, int * buf_ysize=None, 
            int * buf_type=None, int * buf_pixel_space=None, int * buf_line_space=None) -> CPLErr
        """
...
def RasterizeLayer(*args, **kwargs):
  """
    RasterizeLayer(Dataset dataset, int bands, OGRLayerShadow * layer, void * pfnTransformer=None, void * pTransformArg=None, 
...
def Polygonize(*args, **kwargs):
  """
    Polygonize(Band srcBand, Band maskBand, OGRLayerShadow * outLayer, int iPixValField, char ** options=None, 
...
def ContourGenerate(*args, **kwargs):
  """
    ContourGenerate(Band srcBand, double contourInterval, double contourBase, int fixedLevelCount, int useNoData, 
        double noDataValue, OGRLayerShadow * dstLayer, int idField, int elevField, 
        GDALProgressFunc callback=0, void * callback_data=None) -> int
    """
