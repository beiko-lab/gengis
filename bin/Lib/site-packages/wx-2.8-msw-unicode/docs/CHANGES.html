...
<div class="section">
<h1><a id="id1" name="id1">2.8.9.2</a></h1>
<ul class="simple">
<li>16-Feb-2009</li>
</ul>
<p>Added the wx.lib.agw package, which contiains most of the widgets from
<a class="reference" href="http://xoomer.alice.it/infinity77/main/freeware.html">http://xoomer.alice.it/infinity77/main/freeware.html</a> written by Andrea
...
easier to maintain collections of demo samples as a group.</p>
<p>Added the wx.PyPickerBase class which can be used to derive new picker
...
color picker look and behave lots better on Mac than before.</p>
<p>You can now pass the handler function to the Unbind method.  If it is
...
instances.</p>
<p>Added a new tool to the Widget Inspection Tool that allows you to watch
the events passing through a widget.  It can also be used
independently, see wx.lib.eventwatcher.</p>
</div>
<div class="section">
<h1><a id="id2" name="id2">2.8.9.1</a></h1>
<ul class="simple">
<li>28-Sep-2008</li>
</ul>
...
<div class="section">
<h1><a id="id3" name="id3">2.8.9.0</a></h1>
<ul class="simple">
<li>28-Sep-2008</li>
</ul>
<p>Many minor bug fixes throughout wxWidgets and wxPython.</p>
<p>Fixed wx.lib.embeddedimage to work with Python 2.3.</p>
<p>Fixed PseudoDC hit testing when pure white or pure black are used.</p>
<p>Added support for a 64-bit Windows build for the AMD64 architecture,
(a.k.a. x64.)  This is for Python 2.5 only and is available only as a
Unicode build.</p>
<p>Added the wx.EmptyBitmapRGBA factory function.</p>
<p>Added the wx.lib.wxcairo module which allows the pycairo package to be
...
started sometime in the 1.4.x release series.</p>
<p>Added the wx.lib.graphics module, which is an implementation of the
...
can do a few things more.</p>
<p>Updated wx.Bitmap.CopyFromBuffer to be a bit more flexible. You can
...
code as CopyFromBuffer.</p>
<p>Add wx.lib.mixins.listctrl.ListRowHighlighter for automatic highlighting
of rows in a wx.ListCtrl.</p>
</div>
<div class="section">
<h1><a id="id4" name="id4">2.8.8.1</a></h1>
<ul class="simple">
<li>18-July-2008</li>
</ul>
<p>wx.richtext: Added wrappers for the RichTextPrinting and
RichTextPrintout classes.</p>
<p>Make it easier to replace the check box images used in the
CheckListCtrlMixin class.</p>
<p>Fixed bug in wx.ScrolledWindow when child focus events caused
unneccessary or incorrect scrolling.</p>
<p>Fixed a bug in wx.GridBagSizer where hidden items were not ignored in
part of the layout algorithm.</p>
<p>Several other bugs also fixed.</p>
</div>
<div class="section">
<h1><a id="id5" name="id5">2.8.8.0</a></h1>
<ul class="simple">
<li>23-June-2008</li>
</ul>
<p>Added the PlateButton class from Cody Precord.</p>
<p>Added wx.PyEvtHandler, which supports overriding the ProcessEvent
...
every event sent to the window.</p>
<p>With much help from Anthony Tuininga the code generated by the img2py
...
be used to turn the old behavior back on.</p>
<p>The PyEmbeddedImage class added for the new img2py support can also be
...
the wx.lib.embeddedimage module for details.</p>
<p>Exposed the wx.GenericDatePickerCtrl to wxPython.  On wxGTK and wxMac
...
wx.DefaultDateTime even if wx.DP_ALLOWNONE was specified.</p>
<p>Made a little hack in wx.lib.masked.TextCtrl that allows it to be
...
<p>Enhanced the Widget Inspection Tool with some new functionality.
...
items it will draw an outline around the item for a few seconds.</p>
<p>Copied the sized_controls module to the wx.lib package as the first
step of phasing out the wxaddons package.</p>
<p>Added an implementation of wx.Window.SetDoubleBuffered on Windows.
(GTK already has one, and Mac doesn't need one because everything is
always double buffered by the system there.)</p>
<p>Added a wrapper to wx.TopLevelWindow for MacGetTopLevelWindowRef to
...
flag in the caption:</p>
<pre class="literal-block">
&gt;&gt;&gt; import ctypes
&gt;&gt;&gt; carbon = ctypes.CDLL('/System/Library/Carbon.framework/Carbon')
&gt;&gt;&gt; carbon.SetWindowModified(frame.MacGetTopLevelWindowRef(), True)
</pre>
<p>Added a new light-weight solution for embedding ActiveX controls in
wxPython applications that uses ctypes and the comtypes package
available from <a class="reference" href="http://starship.python.net/crew/theller/comtypes/">http://starship.python.net/crew/theller/comtypes/</a>.
...
see the docstring in the wx.lib.activex module for details.</p>
<p>The wx.lib.iewin, wx.lib.pdfwin, and wx.lib.flashwin modules were
...
are available in the wx.lib with &quot;_old&quot; added to the names.</p>
<p>Added the wx.lib.resizewidget module.  This module provides the
...
<div class="section">
<h1><a id="id6" name="id6">2.8.7.1</a></h1>
<ul class="simple">
<li>29-Nov-2007</li>
</ul>
<p>Applied Patch [ 1783958 ] to use the native renderer for drawing the
checkboxes in CheckListCtrlMixin.</p>
<p>Incorporated the new version of XRCed.  This is the result of a Google
...
<a class="reference" href="http://wiki.wxpython.org/XRCed_Refactoring_Project">http://wiki.wxpython.org/XRCed_Refactoring_Project</a></p>
<p>wxMac: Fixed wx.BusyInfo so it doesn't steal the activated status
from the parent window.  (This actually applies to all frames with the
wx.FRAME_TOOL_WINDOW style and no decorations.)</p>
<p>wxMac: Fixed the lack of painting the area between scrollbars on
Leopard.</p>
<p>wxMac: Fixed assertion errors dealing with toolbars on Leopard.</p>
<p>wxMac: Multiline textcontrols now support attributes for margins and
alignement; only a single tab distance can be set though.</p>
<p>Added the wx.Image.AdjustChannels method.  This function muliplies all
4 channels (red, green, blue, alpha) with a factor (around
1.0). Useful for gamma correction, colour correction and to add a
certain amount of transparency to a image.</p>
<p>Added Editra to the distribution, to give us a simple yet powerful
...
<a class="reference" href="http://editra.org/">http://editra.org/</a></p>
<p>wxGTK: wx.Frame.ShowFullScreen now preserves the menubar's
accelerators.</p>
<p>wxGTK: wx.GetClientDisplayRect fixed.</p>
<p>Applied patch [1838043], which adds a demo of the wx.RendererNative
class functionality.</p>
<p>Applied patch [1837449], which uses wx.RenderNative for drawing the
combo button in the PopupControl.</p>
<p>Added GetDirItemData to wx.GenericDirCtrl, which returns a reference
to the data object associated with an item in the control.  (Patch
#1836326)</p>
</div>
<div class="section">
<h1><a id="id7" name="id7">2.8.6.1</a></h1>
<ul class="simple">
<li>26-Oct-2007</li>
</ul>
<p>wxMac: Fixed paste bug when the clipboard contains unicode text.</p>
<p>AUI: Added missing event binders for the notebok tab events.</p>
<p>wxMac: Fixed bug that resulted in portions of virtual listctrl's to
not be repainted when scrolling with PgUp/PgDown/Home/End.</p>
<p>wxMac: Fixed bug that broke tab traversal when tabbing runs into a
wx.StaticBox.</p>
<p>wxGTK:  Add wx.Window.GetGtkWidget.</p>
<p>All: Undprecated wx.ListCtrl.[G|S]etItemSpacing</p>
<p>All: Fixed wx.Palette constructor wrapper.  It takes three seqences of
...
integer values in the range of 0..255 inclusive.</p>
<p>Thanks to some grunt work from Edouard TISSERANT, wxPython now has the
needed tweaks in config.py to be able to be built with mingw32.  See
BUILD.txt for details.</p>
<p>Changes in wx.GraphicsContext to make things like the half-pixel
offsets more consistent across platforms.</p>
<p>wxMSW: If freezing a top-level window wxWidgets will actually freeze
...
<div class="section">
<h1><a id="id8" name="id8">2.8.6.0</a></h1>
<ul class="simple">
<li>27-Sept-2007</li>
</ul>
<p>This release is mostly about fixing a number of bugs and
...
<p>Some Menu APIs added to make things more consistent.  Added
...
without mnemonics/accelerators.</p>
<p>Added wx.BORDER_THEME style.  This style will attempt to use a theme
...
<div class="section">
<h1><a id="id9" name="id9">2.8.4.2</a></h1>
<ul class="simple">
<li>8-Aug-2007</li>
</ul>
<p>Added some SWIG magic that allows wx C++ lists to be exposed to
...
<p>Updated wrappers for the RichTextCtrl classes that were already
wrapped, and added support for loading rich xml files and saving as
HTML or XML.</p>
<p>Added wxRoses sample from Ric Werme.</p>
<p>Added better wrappers for wx.OutputStream and wxPython now deals with
...
appropriately.</p>
<p>Added some patches from Billy B. that improve the pySketch sample.</p>
<p>Added patch from Chris Mellon that gives PyShell a custom context
menu that is better integrated with the shell environment.</p>
<p>There are now new build scripts for making the Universal binaries and
...
Panther and Tiger, and on PPC and i386.</p>
<p>On the Linux side the debian and ubuntu packages will support multiple
...
<div class="section">
<h1><a id="id10" name="id10">2.8.4.0</a></h1>
<ul class="simple">
<li>14-May-2007</li>
</ul>
...
<div class="section">
<h1><a id="id11" name="id11">2.8.3.0</a></h1>
<ul class="simple">
<li>22-March-2007</li>
</ul>
...
<div class="section">
<h1><a id="id12" name="id12">2.8.1.1</a></h1>
<ul class="simple">
<li>19-Jan-2007</li>
</ul>
...
<div class="section">
<h1><a id="id13" name="id13">2.8.1.0</a></h1>
<ul class="simple">
<li>8-Jan-2007</li>
</ul>
...
<div class="section">
<h1><a id="id14" name="id14">2.8.0.1</a></h1>
<ul class="simple">
<li>11-Dec-2006</li>
</ul>
...
<div class="section">
<h1><a id="id15" name="id15">2.7.2.0</a></h1>
<ul class="simple">
<li>7-Nov-2006</li>
</ul>
...
<div class="section">
<h1><a id="id16" name="id16">2.7.1.3</a></h1>
<ul class="simple">
<li>26-Oct-2006</li>
</ul>
...
<div class="section">
<h1><a id="id17" name="id17">2.7.1.2</a></h1>
<ul class="simple">
<li>21-Oct-2006</li>
</ul>
...
<div class="section">
<h1><a id="id18" name="id18">2.7.1.1</a></h1>
<ul class="simple">
<li>18-Oct-2006</li>
</ul>
...
<div class="section">
<h1><a id="id19" name="id19">2.6.3.3</a></h1>
<ul class="simple">
<li>15-July-2006</li>
</ul>
<dl class="docutils">
...
<div class="section">
<h1><a id="id20" name="id20">2.6.3.2</a></h1>
<ul class="simple">
<li>3-April-2006</li>
</ul>
...
<div class="section">
<h1><a id="id21" name="id21">2.6.3.0</a></h1>
<ul class="simple">
<li>27-March-2006</li>
</ul>
...
<div class="section">
<h1><a id="id22" name="id22">2.6.2.1</a></h1>
<ul class="simple">
<li>10-Jan-2006</li>
</ul>
...
<div class="section">
<h1><a id="id23" name="id23">2.6.1.0</a></h1>
<ul class="simple">
<li>4-June-2005</li>
</ul>
...
<div class="section">
<h1><a id="id24" name="id24">2.6.0.1</a></h1>
<ul class="simple">
<li>30-May-2005</li>
</ul>
...
<div class="section">
<h1><a id="id25" name="id25">2.6.0.0</a></h1>
<ul class="simple">
<li>26-Apr-2005</li>
</ul>
...
<div class="section">
<h1><a id="id26" name="id26">2.5.5.1</a></h1>
<ul class="simple">
<li>8-Apr-2005</li>
</ul>
...
<div class="section">
<h1><a id="id27" name="id27">2.5.4.1</a></h1>
<ul class="simple">
<li>16-Mar-2005</li>
</ul>
...
<div class="section">
<h1><a id="id28" name="id28">2.5.3.1</a></h1>
<ul class="simple">
<li>9-Nov-2004</li>
</ul>
...
<div class="section">
<h1><a id="id29" name="id29">2.5.2.8</a></h1>
<ul class="simple">
<li>27-Aug-2004</li>
</ul>
...
<div class="section">
<h1><a id="id30" name="id30">2.5.2.7</a></h1>
<ul class="simple">
<li>14-Aug-2004</li>
</ul>
...
<div class="section">
<h1><a id="id32" name="id32">2.4.2.4</a></h1>
<ul class="simple">
<li>1-Oct-2003</li>
</ul>
...
<div class="section">
<h1><a id="id33" name="id33">2.4.1.2</a></h1>
<ul class="simple">
<li>19-Jun-2003</li>
</ul>
...
<div class="section">
<h1><a id="id34" name="id34">2.4.0.7</a></h1>
<ul class="simple">
<li>24-Mar-2003</li>
</ul>
...
<div class="section">
<h1><a id="id35" name="id35">2.4.0.4</a></h1>
<ul class="simple">
<li>7-Mar-2003</li>
</ul>
...
<div class="section">
<h1><a id="id36" name="id36">2.4.0.2</a></h1>
<ul class="simple">
<li>23-Jan-2003</li>
</ul>
...
<div class="section">
<h1><a id="id37" name="id37">2.4.0.1</a></h1>
<ul class="simple">
<li>10-Jan-2003</li>
</ul>
...
<div class="section">
<h1><a id="id38" name="id38">2.3.4.2</a></h1>
<ul class="simple">
<li>21-Dec-2002</li>
</ul>
...
<div class="section">
<h1><a id="id39" name="id39">2.3.4.1</a></h1>
<ul class="simple">
<li>18-Dec-2002</li>
</ul>
...
<div class="section">
<h1><a id="id40" name="id40">2.3.3.1</a></h1>
<ul class="simple">
<li>19-Sep-2002</li>
</ul>
...
<div class="section">
<h1><a id="id41" name="id41">2.3.2.1</a></h1>
<ul class="simple">
<li>20-Dec-2001</li>
</ul>
...
<div class="section">
<h1><a id="id42" name="id42">2.3.2</a></h1>
<ul class="simple">
<li>11-Dec-2001</li>
</ul>
...
<div class="section">
<h1><a id="id43" name="id43">2.3.1</a></h1>
<ul class="simple">
<li>10-Jul-2001</li>
</ul>
...
<div class="section">
<h1><a id="id44" name="id44">2.3.0</a></h1>
<ul class="simple">
<li>22-May-2001</li>
</ul>
...
<div class="section">
<h1><a id="id45" name="id45">2.2.7</a></h1>
<ul class="simple">
<li>19-Jun-2001</li>
</ul>
...
<div class="section">
<h1><a id="id46" name="id46">2.2.5</a></h1>
<ul class="simple">
<li>30-Jan-2001</li>
</ul>
