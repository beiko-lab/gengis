...
#            (ur'(\.)(%s|%s|`[^`]+`)' % (idrest, op), bygroups(Operator, Name.Attribute)),
        ...
        'type': [
            ...
            (r'[\(\{]', Operator, '#push'),
            (ur'((?:\.|%s|%s|`[^`]+`)+)([\s]*)(\[)' % (idrest, op), bygroups(Keyword.Type, Text, Operator), 'typeparam'),
            (ur'((?:\.|%s|%s|`[^`]+`)+)(\s*)$' % (idrest, op), bygroups(Keyword.Type, Text), '#pop'),
