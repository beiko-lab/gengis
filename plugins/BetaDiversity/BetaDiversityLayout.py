...
###########################################################################
## Class BetaDiversityLayout
###########################################################################

class BetaDiversityLayout ( wx.Frame ):
	
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Beta diversity calculator", pos = wx.DefaultPosition, size = wx.Size( 650,600 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		sbSizer3 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"Hierarchical cluster tree" ), wx.HORIZONTAL )
		
		self.radioSingleLinkage = wx.RadioButton( self, wx.ID_ANY, u"Single (nearest) linkage", wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer3.Add( self.radioSingleLinkage, 0, wx.ALL, 5 )
		
		self.radioUPGMA = wx.RadioButton( self, wx.ID_ANY, u"UPGMA (average) linkage", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.radioUPGMA.SetValue( True ) 
		sbSizer3.Add( self.radioUPGMA, 0, wx.ALL, 5 )
		
		self.radioCompleteLinkage = wx.RadioButton( self, wx.ID_ANY, u"Complete (farthest) linkage", wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer3.Add( self.radioCompleteLinkage, 0, wx.ALL, 5 )
		
		self.radioWeighted = wx.RadioButton( self, wx.ID_ANY, u"WPGMA (weighted) linkage", wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer3.Add( self.radioWeighted, 0, wx.ALL, 5 )
		
		bSizer9.Add( sbSizer3, 0, wx.ALL|wx.EXPAND, 5 )
		...
		self.btnSaveDissMatrix = wx.Button( self, wx.ID_ANY, u"Save dissimilarity matrix", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer2.Add( self.btnSaveDissMatrix, 0, wx.ALL, 5 )
		
		self.btnSaveTree = wx.Button( self, wx.ID_ANY, u"Save cluster tree", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer2.Add( self.btnSaveTree, 0, wx.ALL, 5 )
		...
		self.btnSaveDissMatrix.Bind( wx.EVT_BUTTON, self.OnSaveDissMatrix )
		self.btnSaveTree.Bind( wx.EVT_BUTTON, self.OnSaveTree )
