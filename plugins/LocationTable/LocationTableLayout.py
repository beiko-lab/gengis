...
###########################################################################
## Class LocationTableLayout
###########################################################################

class LocationTableLayout ( wx.Frame ):
	
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Location table", pos = wx.DefaultPosition, size = wx.Size( 1000,600 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.chkShowAll = wx.CheckBox( self, wx.ID_ANY, u"Show data for all locations", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer10.Add( self.chkShowAll, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		self.chkShowAll.Bind( wx.EVT_CHECKBOX, self.OnShowAll )
