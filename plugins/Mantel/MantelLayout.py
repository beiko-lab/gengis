...
class MantelLayout ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Mantel Test", pos = wx.DefaultPosition, size = wx.Size( 800,731 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL|wx.VSCROLL )
		...
		sbSizer5 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"Independent data" ), wx.VERTICAL )
		
		self.radioLocationIndependent = wx.RadioButton( self, wx.ID_ANY, u"Use location data", wx.DefaultPosition, wx.DefaultSize, wx.RB_GROUP )
		self.radioLocationIndependent.SetValue( True ) 
		sbSizer5.Add( self.radioLocationIndependent, 0, wx.ALL, 5 )
		
		self.radioSeqIndependent = wx.RadioButton( self, wx.ID_ANY, u"Use sequence data", wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer5.Add( self.radioSeqIndependent, 0, wx.ALL, 5 )
		
		self.radioFileIndependent = wx.RadioButton( self, wx.ID_ANY, u"Load from file", wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer5.Add( self.radioFileIndependent, 0, wx.ALL, 5 )
		
		self.btnSelectFileIndependent = wx.Button( self, wx.ID_ANY, u"Select file", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.btnSelectFileIndependent.Enable( False )
		
		sbSizer5.Add( self.btnSelectFileIndependent, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.lblFileIndependent = wx.StaticText( self, wx.ID_ANY, u"<none>", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTRE )
		...
		sbSizer6 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"Dependent data" ), wx.VERTICAL )
		
		self.radioLocationDependent = wx.RadioButton( self, wx.ID_ANY, u"Use location data", wx.DefaultPosition, wx.DefaultSize, wx.RB_GROUP )
		self.radioLocationDependent.SetValue( True ) 
		sbSizer6.Add( self.radioLocationDependent, 0, wx.ALL, 5 )
		
		self.radioSeqDependent = wx.RadioButton( self, wx.ID_ANY, u"Use sequence data", wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer6.Add( self.radioSeqDependent, 0, wx.ALL, 5 )
		
		self.radioFileDependent = wx.RadioButton( self, wx.ID_ANY, u"Load from file", wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer6.Add( self.radioFileDependent, 0, wx.ALL, 5 )
		
		self.btnSelectFileDependent = wx.Button( self, wx.ID_ANY, u"Select file", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.btnSelectFileDependent.Enable( False )
		
		sbSizer6.Add( self.btnSelectFileDependent, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.lblFileDependent = wx.StaticText( self, wx.ID_ANY, u"<none>", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTRE )
