...
class ShowSpreadLayout ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		fgSizer1.Add( self.m_DataText, 0, wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_StopChoice, 0, wx.ALL|wx.EXPAND, 5 )
		...
		fgSizer1.Add( self.m_StepsText, 0, wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_staticTime, 0, wx.ALL, 5 )
		...
		fgSizer3.Add( self.m_BinStartText, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		
		m_choice5Choices = []
		self.m_choice5 = wx.Choice( self.m_Page2, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_choice5Choices, 0 )
		self.m_choice5.SetSelection( 0 )
		fgSizer3.Add( self.m_choice5, 0, wx.ALL|wx.EXPAND, 5 )
		...
		fgSizer3.Add( self.m_BinEndText, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		
		m_choice6Choices = []
		self.m_choice6 = wx.Choice( self.m_Page2, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_choice6Choices, 0 )
		self.m_choice6.SetSelection( 0 )
		fgSizer3.Add( self.m_choice6, 0, wx.ALL|wx.EXPAND, 5 )
